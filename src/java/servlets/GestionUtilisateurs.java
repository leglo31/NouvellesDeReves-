...
public class GestionUtilisateurs extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        UtilisateurDAO u = new UtilisateurDAO();
          List<beans.Utilisateur> listUtilisateur = new ArrayList<>();
          listUtilisateur = u.getAll();
          
          System.out.println(listUtilisateur);
          
          request.setAttribute("essaiUtilisateur", listUtilisateur);
        
        
        
        
        getServletContext().getRequestDispatcher("/WEB-INF/gestionUtilisateurs.jsp").forward(request, response);
